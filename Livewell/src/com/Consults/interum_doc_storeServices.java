 ...
 * @author G
 */
public class interum_doc_storeServices {
    ...
    public interum_doc_storeServices() {
    }

    public interum_doc_storeServices(String code, String drug_name, String drug_type, String drug_composition, Double price) {
        this.code = code;
    ...
    public Service<Boolean> insert_interum_drug() {
                ...
                return new Task<Boolean>() {
                    ...
                    protected Boolean call() throws Exception {
                        try {
                            ...
                            sql = "insert into presc_drugs(code,drug_name,drug_type,drug_composition,price) "
                                    + "values(?,?,?,?,?)";
                            pst = conn.prepareStatement(sql);
                            pst.setString(1, code.trim());
                            pst.setString(2, drug_name.trim());
                            pst.setString(3, drug_type.trim());
                            pst.setString(4, drug_composition);   
    ...
    public Service<Boolean> update_interum_drug() {
        Service<Boolean> service = new Service<Boolean>() {
            @Override
            protected Task<Boolean> createTask() {
                return new Task<Boolean>() {
